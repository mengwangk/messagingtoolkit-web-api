...
{
    public sealed class UpdateIncomingMessageCommandHandler : CommandHandlerBase, ICommandHandler<UpdateIncomingMessageCommand, Incoming>
    {
        public Incoming Process(UpdateIncomingMessageCommand command)
        {
